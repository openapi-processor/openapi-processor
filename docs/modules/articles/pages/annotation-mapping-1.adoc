...
The xref:new:spring-2022.5.adoc[openapi-processor-spring/micronaut release 2022.5] adds a new _annotation type mapping_ feature. It provides the possibility to add additional annotations to generated interfaces & classes.
