...
=== link:https://dev.to/hauner/openapi-processor-spring-type-mapping-4ecj[openapi-processor-spring type mapping]
=== link:https://dev.to/hauner/configuring-openapi-processor-maven-39pf[openapi-processor-maven]
=== link:https://dev.to/hauner/openapi-processor-spring-368k[openapi-processor-spring intro]
